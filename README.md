...
### Desenvolvedor PHP/Laravel Júnior | Backend & Full Stack
...
Sou desenvolvedor web com experiência profissional no desenvolvimento e manutenção de **sistemas corporativos e ERPs**, atuando principalmente com PHP, Laravel, JavaScript, PostgreSQL e Firebird.

Atualmente, trabalho com desenvolvimento de funcionalidades, APIs REST, integrações, regras de negócio e automações para aplicações web.

- 🎓 Formado em Análise e Desenvolvimento de Sistemas pela FATEC Ourinhos.
- 💻 Foco em desenvolvimento Backend e Full Stack.
- 📚 Aprimorando meus conhecimentos em arquitetura de software, infraestrutura e segurança.
- 🤖 Interessado em inteligência artificial aplicada ao desenvolvimento de software.
- 🌎 Aberto a oportunidades remotas ou híbridas.
...
- Docker, Linux e infraestrutura de servidores.
